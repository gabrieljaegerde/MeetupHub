...
export type Ia3633h9pfkn7c = Array<Anonymize<I3kmljsfe0gs24>>;
export type I3kmljsfe0gs24 = {
    "phase": Phase;
...
export type Id1b6jh4cusamh = AnonymousEnum<{
    ...
    "CannotLookup": undefined;
    "BadOrigin": undefined;
    "Module": Anonymize<Ibme1jrqam2sql>;
    "ConsumerRemaining": undefined;
    "NoProviders": undefined;
    "TooManyConsumers": undefined;
    "Token": TokenError;
...
export type Ibme1jrqam2sql = AnonymousEnum<{
    "System": Anonymize<I5o0s7c8q1cc9b>;
...
export type Ic4l4p5329mqka = ResultPayload<Anonymize<Ifg8p3pjk2fdit>, Anonymize<I55ku9c5gk50hb>>;
export type Ifg8p3pjk2fdit = {
    "execution_result": Anonymize<I1grthkg04738n>;
    "emitted_events": Anonymize<I2jj85brfrm4p2>;
    "local_xcm"?: Anonymize<I3i0ce56p044d2>;
    "forwarded_xcms": Anonymize<I47tkk5e5nm6g7>;
};
export type I1grthkg04738n = ResultPayload<Anonymize<Ia1u1r3n74r13c>, Anonymize<I95b0r5if5gl9g>>;
export type I95b0r5if5gl9g = {
    "post_info": Anonymize<Ia1u1r3n74r13c>;
    "error": Anonymize<Id1b6jh4cusamh>;
};
export type I2jj85brfrm4p2 = Array<Anonymize<Id5ug5m0fg64gg>>;
export type I28cpqn91oi3ns = ResultPayload<Anonymize<I6it5v0rv6lrbe>, Anonymize<I55ku9c5gk50hb>>;
export type I6it5v0rv6lrbe = {
    "execution_result": XcmV4TraitsOutcome;
    "emitted_events": Anonymize<I2jj85brfrm4p2>;
    "forwarded_xcms": Anonymize<I47tkk5e5nm6g7>;
};
...
export type I3rhi54ul5h73k = Array<Anonymize<I5in32b1kaie58>>;
export type I5in32b1kaie58 = {
    "phase": Phase;
    "event": Anonymize<I7ol4cfd6hrmuf>;
    "topics": Anonymize<Ic5m5lp1oioo8r>;
};
export type I7ol4cfd6hrmuf = AnonymousEnum<{
...
export type Ied512kvf4qa3k = AnonymousEnum<{
    /**
     *Send a batch of dispatch calls.
     *
     *May be called from any origin except `None`.
     ...
     *event is deposited.
     */
    "batch": Anonymize<I9chhse5dmm5st>;
    /**
     *Send a call through an indexed pseudonym of the sender.
     *
     *Filter from origin are passed along. The call will be dispatched with an origin which
     ...
     *The dispatch origin for this call must be _Signed_.
     */
    "as_derivative": Anonymize<I9dflg1do4vis7>;
    /**
     *Send a batch of dispatch calls and atomically execute them.
     *The whole transaction will rollback and fail if any of the calls failed.
     *
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    "batch_all": Anonymize<I9chhse5dmm5st>;
    /**
     *Dispatches a function call with a provided origin.
     *
     *The dispatch origin for this call must be _Root_.
     ...
     *- O(1).
     */
    "dispatch_as": Anonymize<Icp4r8giaqdkk6>;
    /**
     *Send a batch of dispatch calls.
     *Unlike `batch`, it allows errors and won't interrupt.
     *
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    "force_batch": Anonymize<I9chhse5dmm5st>;
    /**
     *Dispatch a function call with a specified weight.
     *
     *This function does not check the weight of the call, and instead allows the
     ...
     *The dispatch origin for this call must be _Root_.
     */
    "with_weight": Anonymize<I7c72a7suk6k2s>;
}>;
export type I9chhse5dmm5st = {
    "calls": Anonymize<I36apuf1qernvq>;
};
export type I36apuf1qernvq = Array<TxCallData>;
export type I9dflg1do4vis7 = {
    "index": number;
    "call": TxCallData;
};
export type Icp4r8giaqdkk6 = {
    "as_origin": Anonymize<I48v5riethqckl>;
    "call": TxCallData;
};
export type I7c72a7suk6k2s = {
    "call": TxCallData;
    "weight": Anonymize<I4q39t5hn830vp>;
};
export type I7n38a5iqp6l60 = AnonymousEnum<{
    /**
     *Immediately dispatch a multi-signature call using a single approval from the caller.
     *
     *The dispatch origin for this call must be _Signed_.
     ...
     *O(Z + C) where Z is the length of the call and C its execution weight.
     */
    "as_multi_threshold_1": Anonymize<I1ha0p3fibe179>;
    /**
     *Register approval for a dispatch to be made from a deterministic composite account if
     *approved by a total of `threshold - 1` of `other_signatories`.
     *
     ...
     *  taken for its lifetime of `DepositBase + threshold * DepositFactor`.
     */
    "as_multi": Anonymize<I34bhbjo61p52>;
    /**
     *Register approval for a dispatch to be made from a deterministic composite account if
     *approved by a total of `threshold - 1` of `other_signatories`.
     *
...
export type I1ha0p3fibe179 = {
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "call": TxCallData;
};
export type I34bhbjo61p52 = {
    "threshold": number;
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "maybe_timepoint"?: Anonymize<I95jfd8j5cr5eh>;
    "call": TxCallData;
...
export type I6elk1fs4ubi9o = AnonymousEnum<{
    /**
     *Dispatch the given `call` from an account that the sender is authorised for through
     *`add_proxy`.
     *
     ...
     *- `call`: The call to be made by the `real` account.
     */
    "proxy": Anonymize<I8873hm0nl14gj>;
    /**
     *Register a proxy account for the sender that is able to make calls on its behalf.
     *
     *The dispatch origin for this call must be _Signed_.
     ...
     *- `call`: The call to be made by the `real` account.
     */
    "proxy_announced": Anonymize<I8jjktagec0qms>;
}>;
export type I8873hm0nl14gj = {
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<I7rk1n3vg3et43>;
    "call": TxCallData;
};
export type I8jjktagec0qms = {
    "delegate": MultiAddress;
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<I7rk1n3vg3et43>;
    "call": TxCallData;
...
export type I7kclmqit4pj74 = AnonymousEnum<{
    "System": Anonymize<Iekve0i6djpd9f>;
    ...
    "ToKusamaXcmRouter": Anonymize<I6epb28bkd5aqn>;
    "MessageQueue": Anonymize<Ic2uoe7jdksosp>;
    "Utility": Anonymize<Ied512kvf4qa3k>;
    "Multisig": Anonymize<I7n38a5iqp6l60>;
    "Proxy": Anonymize<I6elk1fs4ubi9o>;
...
export type I388a928dv68de = ResultPayload<Anonymize<I1u6mqqaipsaf0>, Anonymize<I55ku9c5gk50hb>>;
export type I1u6mqqaipsaf0 = {
    "execution_result": Anonymize<Ic6s0p82uhoidt>;
    "emitted_events": Anonymize<I60lj6sqnmcqlr>;
    "local_xcm"?: Anonymize<I3i0ce56p044d2>;
    "forwarded_xcms": Anonymize<I47tkk5e5nm6g7>;
};
...
export type I60lj6sqnmcqlr = Array<Anonymize<I7ol4cfd6hrmuf>>;
export type I2dpmmbjqg9tfn = ResultPayload<Anonymize<I443o5g78b14t9>, Anonymize<I55ku9c5gk50hb>>;
export type I443o5g78b14t9 = {
    "execution_result": XcmV4TraitsOutcome;
    "emitted_events": Anonymize<I60lj6sqnmcqlr>;
    "forwarded_xcms": Anonymize<I47tkk5e5nm6g7>;
};
