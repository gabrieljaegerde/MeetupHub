...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I3rhi54ul5h73k>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I9chhse5dmm5st>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I9dflg1do4vis7>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I9chhse5dmm5st>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Icp4r8giaqdkk6>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I9chhse5dmm5st>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I7c72a7suk6k2s>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I1ha0p3fibe179>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I34bhbjo61p52>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I8873hm0nl14gj>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I8jjktagec0qms>>;
    };
    Assets: {
        /**
...
type IRuntimeCalls = {
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I7kclmqit4pj74>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I7kclmqit4pj74>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<I7kclmqit4pj74>], Anonymize<I388a928dv68de>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I2dpmmbjqg9tfn>>;
    };
    /**
...
export type Polkadot_asset_hubDispatchError = Anonymize<Icogrvf0inr18b>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Polkadot_asset_hubCallData = Anonymize<I7kclmqit4pj74> & {
    value: {
        type: string;
    };
};
